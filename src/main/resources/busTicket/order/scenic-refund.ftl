...
<head>
    ...
    <link href="/res/style/bus/scenic-refund.css?v=${version!}" rel="stylesheet" type="text/css">
</head>
<body>
...
<div class="lump ticket-info-content">
    ...
    <ul>
        <li class="sui-border-b">
            ...
            <div id="canRefundNum" class="value">0张</div>
        </li>
        <li class="sui-border-b">
            <div class="name">退票张数</div>
            <div id="refundNum" class="value">0张</div>
        </li>
        <li class="sui-border-b">
            <div class="name">总票价</div>
            <div id="totalPrice" class="value price">0元</div>
        </li>
        <li class="sui-border-b">
            <div class="name">总退票手续费</div>
            <div id="serviceFee" class="value price">0元</div>
        </li>
        <li class="sui-border-b">
            <div class="name">预计退票款金额<span>（实际退款金额以景点提供为准）</span></div>
            <div id="estimateRefundAmount" class="value price">0元</div>
        </li>
    </ul>
</div>
...
<div class="lump refund-info-content">
    ...
    <ul>
        <li data-value="1" data-title="入园不方便" class="active">
...
<script type="text/javascript" src="/js/busTicket/order/scenic-refund.js?v=${version!}"></script>
</body>
</html>