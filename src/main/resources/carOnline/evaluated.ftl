...
<div id="wait-instant">
    ...
    <div class="btn-group">
        <div data-href="/passenger/onlineCarOrderList.html" class="btn">订单列表</div>
        <div data-href="/onlineIndex" class="btn">再次约车</div>
    </div>
...
<script src="/js/carOnline/evaluated.js?v=${version!}"></script>
