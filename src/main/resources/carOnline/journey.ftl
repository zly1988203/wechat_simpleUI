...
<body>
<input type="hidden" id="realPrice" value="${driverInfo.realPrice!0}">
<input type="hidden" id="couponMoney" value="${driverInfo.couponMoney}">
<input type="hidden" id="status" value="${driverInfo.status}">
<input type="hidden" id="calculateType" value="${driverInfo.calculateType!0}">
   ...
   <script src="/js/coupons/coupons.js?v=${version!}"></script>
    ...
    <script src="/js/carOnline/journey.js?v=${version!}"></script>
