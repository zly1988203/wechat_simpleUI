...
var loadMaps = function(areaInfo) {
    ...
    var url = SERVER_URL_PREFIX +  '/hail/innerCity/optimize/getRegionLineArea';
    var dataObj = param;
...
function loadAreaBylat(param) {
    ...
    var locationHref = '/hail/interCityIndex';
    if(null != areaInfo){
...
function btnClick_event() {
    //点击确定返回
    $('#mapResult button').on('tap', function() {
