...
<input type="hidden" id="pageUrl" value="/hail/interCityIndex">
...
<script src="/js/hail_innerCity/common.js?v=${version}"></script>
<script src="/js/hail_innerCity/index.js?v=${version}"></script>
</body>
</html>
