...
<input type="hidden" id="refundDesc" placeholder="退款原因" value="${orderInfo.refundDesc!''}"/>
...
<input type="hidden" id="status" placeholder="出行时间" value="${orderInfo.status!'0'}"/>
<input type="hidden" id="payStatus" placeholder="支付状态" value="${orderInfo.payStatus!'0'}"/>
<div class="main-container">
    ...
    <!--订单状态信息 默认乘客取消-->
    <div class="cancel-status-container">
        <div class="status">
            <div class="result">订单取消成功</div>
        </div>
        <div class="tips">你可以重新预约用车</div>
    </div>
    <!--订单状态信息 客服取消-->
    <!--<div class="cancel-status-container service-cancel">
        <div class="status">
            <div class="result">客服已取消订单</div>
        </div>
        <div class="tips">你可以重新预约用车</div>
    </div>-->
    <!--退款详情信息-->
    ...
    <!--按钮-->
    <div class="btn-group">
        <div class="btn normal">返回</div>
        <div class="btn protrude">重新预约</div>
    </div>
</div>
    ...
    <script src="/js/hail_innerCity/order/orderDetailRefund.js?v=${version!}"></script>
</body>
</html>
