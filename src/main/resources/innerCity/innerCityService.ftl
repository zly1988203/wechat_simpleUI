...
<head>
    ...
    <link href="/res/style/base/select-picker.css?v=${version!}" rel="stylesheet" type="text/css">
...
<body>
<input type="hidden" id="pageUrl" value="/innerCity/order/innerCityService">
...
<script type="text/javascript" src="/js/innerCityJs/common.js?v=${version!}"></script>
<script type="text/javascript" src="/js/innerCityJs/innerCityService.js?v=${version!}"></script>
</body>
</html>