 ...
 */
@Controller
@RequestMapping("/hail/order")
public class HailOrderController extends HailController {
	private static final Logger LOGGER = LoggerFactory.getLogger(HailOrderController.class);
