 ...
 *
 */
@Controller("HailOnlineCarOrderController")
@RequestMapping("/hail")
public class OnlineCarOrderController extends HailController {
	...
	public String orderdetail(HttpServletRequest request,Model model,String orderNo,@RequestParam(required = false,defaultValue = "") String payStatus) {
		...
		return "hail/onlineCarOrderDetail";
	}
