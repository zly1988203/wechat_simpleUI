...
public class StationParam extends BaseParam {
	...
	public boolean checkDepartParam() {
		return this.checkRequestUrl()&&(this.getDepartAreaCode()!=null && this.getDepartLat()!=null &&
	...
	public boolean checkArriveParam() {
		return this.checkRequestUrl()&&(this.getArriveAreaCode()!=null && this.getArriveLat()!=null &&
