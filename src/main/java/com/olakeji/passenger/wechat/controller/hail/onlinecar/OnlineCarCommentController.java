...
@Controller("HailOnlineCarCommentController")
@RequestMapping("/hail/onlineComment")
public class OnlineCarCommentController extends HailController {
